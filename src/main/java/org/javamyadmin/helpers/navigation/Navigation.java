...
public class Navigation {
     ...
     * @throws SQLException 
     */
    public String getDisplay(HttpServletRequest httpRequest, SessionMap sessionMap, Globals GLOBALS) throws SQLException
    {
        ...
        String $navRender = "";
        if (! $response.isAjax()
            || ! empty(httpRequest.getParameter("full"))
     ...
     * @return void
     */
    public void unhideNavigationItem(
        String $itemName,
        String $itemType,
        String $dbName,
        String $tableName /*= null*/
